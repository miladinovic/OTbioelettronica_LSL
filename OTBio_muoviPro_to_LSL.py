...
def send_default_configuration(client):
...
def main():
    ...
    ch_labels = ['MuoviI-1','MuoviI-2','MuoviI-3','MuoviI-4','MuoviI-5','MuoviI-6','MuoviI-7','MuoviI-8','MuoviI-9','MuoviI-10','MuoviI-11','MuoviI-12','MuoviI-13','MuoviI-14','MuoviI-15','MuoviI-16','MuoviI-17','MuoviI-18','MuoviI-19','MuoviI-20','MuoviI-21','MuoviI-22','MuoviI-23','MuoviI-24','MuoviI-25','MuoviI-26','MuoviI-27','MuoviI-28','MuoviI-29','MuoviI-30','MuoviI-31','MuoviI-32','MuoviI-W','MuoviI-X','MuoviI-Y','MuoviI-Z','MuoviI-sync','MuoviI-counter','MuoviII-1','MuoviII-2','MuoviII-3','MuoviII-4','MuoviII-5','MuoviII-6','MuoviII-7','MuoviII-8','MuoviII-9','MuoviII-10','MuoviII-11','MuoviII-12','MuoviII-13','MuoviII-14','MuoviII-15','MuoviII-16','MuoviII-17','MuoviII-18','MuoviII-19','MuoviII-20','MuoviII-21','MuoviII-22','MuoviII-23','MuoviII-24','MuoviII-25','MuoviII-26','MuoviII-27','MuoviII-28','MuoviII-29','MuoviII-30','MuoviII-31','MuoviII-32','MuoviII-W','MuoviII-X','MuoviII-Y','MuoviII-Z','MuoviII-sync','MuoviII-counter','Station-aux-1','Station-aux-2','Station-aux-3','Station-aux-4','Station-sync','Station-counter']
    ...
    try:
        ...
        print("!!! Exception: ",e, ", server didn't respond with any data! Try restarting syncstation and probes! Check out the LEDs!")
        print("- 1 & 2 green led on syncstation must be ON")
        print("- no red blinking on probes 1 and 2 should be present, if present single blink means DATA_LOSS, triple blinking LOW_BATTERY")
    finally:
